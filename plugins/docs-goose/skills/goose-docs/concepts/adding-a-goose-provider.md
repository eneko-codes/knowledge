...
> Source: https://pressly.github.io/goose/blog/2023/goose-provider
...
As an aside, if you're interested in the topic, Peter Bourgon had a nice post about [global state](<https://peter.bourgon.org/blog/2017/06/09/theory-of-modern-go.html>)
...
Some users got clever and worked around this limitation by using a wrapper that handled locking or even more [ exotic solutions](<https://github.com/pressly/goose/issues/191#issuecomment-1129850138>), such as setting the max number of connections to 1.
...
Kudos to [@roblaszczak](<https://twitter.com/roblaszczak>) for the idea to support a [custom locker interface](<https://github.com/pressly/goose/pull/575>).

If you've been following [ _Add locking mechanism to prevent parallel execution_](<https://github.com/pressly/goose/issues/335>) issue, there's a bit to unpack. We'll save the details for another post.
...
This is a big one. There was no way to get the results of a migration because all success and failure states were logged _from within the package_.
...
If you have any questions or feedback, feel free to reach out on Twitter [@_mfridman](<https://twitter.com/_mfridman>) or file an issue on [ pressly/goose](<https://github.com/pressly/goose>).

ps. It's also an example of how to use functional options in Go, despite their controversial nature. I personally like them, but I can see why some people don't. Here's a great talk by [@jub0bs](<https://twitter.com/jub0bs>) on the topic:
...
Special thanks to [@oliverpool](<https://github.com/oliverpool>) for pitching ideas and working through the design around the `fs.FS` interface. I'm quite happy with how it turned out and I think it's a great example of how to use the new `fs.FS` interface.

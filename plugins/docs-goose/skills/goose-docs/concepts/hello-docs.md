...
> Source: https://pressly.github.io/goose/blog/2021/welcome
...
However, there were a few items left to be desired, and so the Pressly team forked the project in 2016 and has maintained it since. You can read the [Goals of this fork](<https://pressly.github.io/goose/#goals-of-this-fork>) section for more info. But that's enough looking back. Let's look into the **future**.

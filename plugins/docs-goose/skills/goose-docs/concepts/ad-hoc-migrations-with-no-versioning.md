...
> Source: https://pressly.github.io/goose/blog/2021/no-version-migrations
...
`goose` will output _"no new migrations found"_. Because `goose` knows we already applied 3 migrations, so no further work to do.
